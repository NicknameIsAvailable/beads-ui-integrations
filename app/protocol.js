...
/** @typedef {'list-issues'|'update-status'|'edit-text'|'update-priority'|'create-issue'|'list-ready'|'dep-add'|'dep-remove'|'epic-status'|'update-assignee'|'label-add'|'label-remove'|'subscribe-list'|'unsubscribe-list'|'snapshot'|'upsert'|'delete'|'get-comments'|'add-comment'|'delete-issue'|'delete-issues'|'list-workspaces'|'set-workspace'|'get-workspace'|'workspace-changed'|'workspaces-updated'|'generate-analytics'} MessageType */
